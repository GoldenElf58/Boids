...
class Boids:
    def __init__(self, num_boids, screen, perception_radius=75, max_qt=4, max_accel=10, max_velocity=50):
    ...
    def create_boids(self):
        for i in range(self.num_boids):
            ...
            boid = Boid(x, y, angle, speed, self.screen, max_accel=self.max_accel, max_vel=self.max_velocity)
